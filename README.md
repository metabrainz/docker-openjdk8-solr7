...
This image is updated via pull requests to [the `metabrainz/docker-openjdk8-solr7` GitHub repo](https://github.com/metabrainz/docker-openjdk8-solr7) which is derived from [the `docker-solr/docker-solr` GitHub repo](https://github.com/docker-solr/docker-solr).
